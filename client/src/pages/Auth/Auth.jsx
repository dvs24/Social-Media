        ...
        <div className="authRight">
          ...
          <form className="infoForm" onSubmit={handleSubmitAuth}>
            ...
            <div className="namePass">
              ...
              <input type="password" name="confirmpass" placeholder="Confirm Password" onChange={props.handleChange} />
            </div>
            {!props.confirmPass && (
              <span style={{ color: 'red', fontSize: '15px', alignSelf: 'flex-end', margin: '15px' }}>
            ...
            <div className="formBtn">
              <span style={{ cursor: 'pointer' }} onClick={() => props.setActive('login')}>
